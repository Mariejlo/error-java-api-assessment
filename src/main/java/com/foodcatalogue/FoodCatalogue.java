 ...
 * This class is abstract because it provides a base for other food-related classes
...
public FoodCatalogue() {
    // initialization code for common attributes     this.category = category; //Parameterized constructor useful for creating instances of subclasses
}
...
//Common methods or abstract methods that the other subclasses can inherit or should implement
...
//Common Attributes apply to all food items such as fruits, vegetables, grains, etc.
